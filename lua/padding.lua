...
p_msisdn  = ProtoField.uint64(NAME .. ".msisdn", "MSISDN")
p_imei  = ProtoField.uint64(NAME .. ".imei", "IMEI")
p_imsi  = ProtoField.uint64(NAME .. ".imsi", "IMSI")
p_tac = ProtoField.uint16(NAME ..".tac", "tac", base.HEX)
...
pad_protocol.fields = {gtpu_teid, resv_teid, src_ipv4, dst_ipv4,p_msisdn,p_imei,p_imsi,p_tac, baseid, tag,resv1, resv2}
...
function pad_protocol.dissector(buffer, pinfo, tree)
    ...
    subtree:add(p_msisdn, buffer(16,7))
    subtree:add(p_imei, buffer(23,7))
    subtree:add(p_imsi, buffer(30,7))
    subtree:add(p_tac, buffer(37,2))
